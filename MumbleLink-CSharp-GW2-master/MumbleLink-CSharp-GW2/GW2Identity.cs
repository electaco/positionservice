...
namespace MumbleLink_CSharp_GW2
{
    public class GW2Identity
    {
        ...
        public float Fov;
        public GW2UiSize UiSize;

        [JsonConstructor]
        public GW2Identity(string name, GW2Profession profession, GW2Race race, int map_id, int world_id, int team_color_id, bool commander, float fov, GW2UiSize uisz)
        {
            Name = name;
